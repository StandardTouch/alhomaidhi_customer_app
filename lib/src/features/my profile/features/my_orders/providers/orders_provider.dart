import 'package:alhomaidhi_customer_app/src/features/my%20profile/features/my_orders/models/my_order_detals_model.dart';
...
final MyOrderDetailsProvider = FutureProvider<MyOrderDetailsModel>((ref) async {
  MyOrderDetailsModel response = await getMyOrderDetails();
  return response;
});
